export function AmbientBackground() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 size-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary-light/10 blur-[130px] dark:bg-primary-light/14" />
    </div>
  );
}
